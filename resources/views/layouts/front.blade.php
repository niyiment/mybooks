...
<head>
    ...
    <title>Biennial/Election General Meeting</title>
...
BGM 2017
    ...
    <header id="site-header" class="site-header valign-center"> 
        <div class="intro">
            ...
            <h2>27th Biennial Conference / Election General Meeting</h2>
            
            <h1>Abuja 2017</h1>
            
            <p>Developing the Economy Sustainable Growth</p>
            <p>The Construction Industry as an Effective Stimulant</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <figure>
                        <img alt="" class="img-responsive" src="{{URL::asset('images/about-us.jpg')}}">
                    </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="{{URL::asset('speaker-1.jpg')}}">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="{{URL::asset('speaker-2.jpg')}}">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="{{URL::asset('speaker-3.jpg')}}">
                        </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="{{URL::asset('speaker-4.jpg')}}">
                        </figure>
                ...
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="{{URL::asset('speaker-5.jpg')}}">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        <figure>
                            <img alt="" class="img-responsive center-block" src="{{URL::asset('speaker-6.jpg')}}">
                        </figure>
                        <h4>Jhon Smith</h4>
                        <p>CEO of Peren</p>
                        <ul class="social-block">
